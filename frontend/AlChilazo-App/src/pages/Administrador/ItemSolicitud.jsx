                ...
                <div className="card" >
                    <div className="row">
                        <div className="col-2" style={{ padding: "10px" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="90" height="90" fill="#527397" className="bi bi-person-circle img-fluid rounded-start" viewBox="0 0 16 16">
                        ...
                        }
                        {
                            props.tipo === 3
                                ...
                                (
                                    <div className="col-6">
                                        <div className="card-body">
                                            <p className="card-text"><label className='label-info'>No. Solicitud: </label>{props.NoSolicitud}</p>
                                            <p className="card-text"><label className='label-info'>Nombre: </label>{props.Nombre}</p>
                                            <p className="card-text"><label className='label-info'>Razon: </label>{props.Razon}</p>
                                        </div>
                                    </div>
                                ) : (<></>)
                        }
